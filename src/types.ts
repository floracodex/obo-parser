...
export interface OboHeader {
    ...
    /** The date the file was generated (verbatim OBO format, e.g., `"01:03:2026 12:00"`). */
    date: string | null;
    /** The username of the person who saved this file. */
    savedBy: string | null;
    /** The tool that auto-generated this file (e.g., `"OWLTools"`, `"ROBOT"`). */
    autoGeneratedBy: string | null;
    ...
    /** ID prefixes whose xrefs should be treated as `has_subclass` relationships. */
    treatXrefsAsHasSubclass: string[];
...
export interface OboTerm extends OboCommonStanza {
    /** Whether this term is built-in to OBO itself. */
    builtin: boolean;
...
export interface OboTypedef extends OboCommonStanza {
    /** Whether this relation is built-in to OBO itself. */
    builtin: boolean;
