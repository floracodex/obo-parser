  ...
  for (const { tag, value } of tags) {
    ...
    switch (tag) {
      ...
      case 'intersection_of':
        ...
        break;
      case 'union_of':
        term.unionOf.push(value.trim());
        break;
      case 'equivalent_to':
        term.equivalentTo.push(value.trim());
        break;
      case 'disjoint_from':
        term.disjointFrom.push(value.trim());
        break;
      default:
...
export function buildTypedef(tags: OboTagValue[]): OboTypedef {
  ...
  const extra = {
    ...
    unionOf: [] as string[],
    equivalentTo: [] as string[],
    disjointFrom: [] as string[],
  ...
  for (const { tag, value } of tags) {
    ...
    switch (tag) {
      ...
      case 'intersection_of':
        ...
        break;
      case 'union_of':
        extra.unionOf.push(value.trim());
        break;
      case 'equivalent_to':
        extra.equivalentTo.push(value.trim());
        break;
      case 'disjoint_from':
        extra.disjointFrom.push(value.trim());
        break;
      case 'domain':
      ...
      case 'equivalent_to_chain':
        extra.equivalentToChain.push(parseChain(value));
        break;
